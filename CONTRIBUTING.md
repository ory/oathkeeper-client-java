...
_Please note_: We take Ory Ory Oathkeeper Java Client's security and our users' trust very
seriously. If you believe you have found a security issue in Ory Ory Oathkeeper Java Client,
...
do this is via
[Ory Ory Oathkeeper Java Client Discussions](https://github.com/ory/meta/discussions)
...
- I have a question. Where can I get
  [answers to questions regarding Ory Ory Oathkeeper Java Client?](#communication)
...
- I want to talk to other Ory Ory Oathkeeper Java Client users.
...
- **Give us a star.** It may not seem like much, but it really makes a
  difference. This is something that everyone can do to help out Ory Ory Oathkeeper Java Client.
...
- **Helping with open issues.** We have a lot of open issues for Ory Ory Oathkeeper Java Client
...
Check out [Ory Ory Oathkeeper Java Client Discussions](https://github.com/ory/meta/discussions). This is a great place for
...
If you want to receive regular notifications about updates to Ory Ory Oathkeeper Java Client,
...
before getting started to ensure your work is consistent with Ory Ory Oathkeeper Java Client's
...
1. Ensure that each commit has a descriptive prefix. This ensures a uniform
   ...
   [list of prefixes for Ory Oathkeeper Java Client](https://github.com/ory/oathkeeper-client-java/blob/master/.github/semantic.yml)
   for an overview.
...
[docs](https://github.com/ory/oathkeeper-client-java/tree/master/docs) folder. Generate API and
configuration reference documentation using `cd docs; npm run gen`.

For further instructions please head over to
[docs/README.md](https://github.com/ory/oathkeeper-client-java/blob/master/README.md).
...
- Private harassment is also unacceptable. No matter who you are, if you feel
  ...
  member, please contact one of the channel ops or a member of the Ory Ory Oathkeeper Java Client
